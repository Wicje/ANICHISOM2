        ...
        <div className="hidden sm:flex gap-4">
          <div className="group relative">
            ...
            <div role="menu" className={cn("absolute top-full left-0 mt-1 transition-transform origin-top-left glass-panel text-xs font-medium rounded-lg shadow-2xl py-1 min-w-[180px] z-[300]", openMenu === 'file' ? "scale-100" : "scale-0 group-hover:scale-100")} style={{ color: 'var(--os-text)' }} onMouseLeave={() => setOpenMenu(null)}>
              <button role="menuitem" className="w-full text-left px-4 py-1.5 transition-colors" style={{ color: 'var(--os-text-muted)' }} onClick={(e) => { e.stopPropagation(); setOpenMenu(null); openWindow('app-store', 'App Store'); }}>App Store & Packages</button>
              <button role="menuitem" className="w-full text-left px-4 py-1.5 transition-colors" style={{ color: 'var(--os-text-muted)' }} onClick={(e) => { e.stopPropagation(); setOpenMenu(null); openWindow('hardware-manager', 'Hardware Manager'); }}>Hardware & USB Manager</button>
          ...
          <div className="group relative">
            ...
            <div role="menu" className={cn("absolute top-full left-0 mt-1 transition-transform origin-top-left glass-panel text-xs font-medium rounded-lg shadow-2xl py-1 min-w-[180px] z-[300]", openMenu === 'view' ? "scale-100" : "scale-0 group-hover:scale-100")} style={{ color: 'var(--os-text)' }} onMouseLeave={() => setOpenMenu(null)}>
              ...
              <button role="menuitem" className="w-full text-left px-4 py-1.5 transition-colors font-bold text-emerald-300" onClick={(e) => { e.stopPropagation(); setOpenMenu(null); window.dispatchEvent(new CustomEvent('os:open-airdrop')); }}>📱 P2P AirDrop Transfer</button>
