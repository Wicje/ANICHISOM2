...
export function ControlCenter({ onClose }: { onClose: () => void }) {
  ...
  return (
    <div className="absolute top-8 right-4 w-[340px] bg-[#1a1a1a] border border-white/20 shadow-2xl rounded-3xl p-4 flex flex-col gap-4 text-white z-[300] animate-in fade-in slide-in-from-top-4 duration-200">
