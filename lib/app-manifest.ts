...
const appRegistry: Record<string, () => Promise<{ default?: React.ComponentType<any>; [key: string]: any }>> = {
  ...
  ai: () => import('@/components/apps/ai-gateway'),
  ...
  'mini-browser': () => import('@/components/apps/mini-browser'),
...
export const APP_MANIFEST: AppManifestEntry[] = [
  ...
  { id: 'browser', component: null as any, icon: Globe, title: 'Mini Browser', roles: ['admin', 'filmmaker', 'technician', 'user'], isCore: false, category: 'dev', description: 'Embedded web browser' },
  { id: 'power-browser', component: null as any, icon: Globe, title: 'Power Browser', roles: ['admin', 'filmmaker', 'technician', 'user'], isCore: false, category: 'dev', description: 'Browser with pinned apps, persistent sessions, and context memory' },
  { id: 'ai', component: null as any, icon: Cpu, title: 'AI Gateway', roles: ['admin', 'filmmaker', 'technician', 'user'], isCore: false, category: 'dev', description: 'AI assistant for natural language control' },
