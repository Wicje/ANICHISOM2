...
const ICO = {
  ...
  // App Store — Glowing brand-green gradient store badge
  ...
  // Book — Apple Books brand-green gradient
  book: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Cdefs%3E%3ClinearGradient id='bg' x1='0' y1='0' x2='1' y2='1'%3E%3Cstop offset='0%25' stop-color='%2300f0ff'/%3E%3Cstop offset='100%25' stop-color='%2310F4A0'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='120' height='120' rx='28' fill='url(%23bg)'/%3E%3Cpath d='M28 32h28c6 0 6 6 6 6v52s0-6-6-6H28z' fill='%23060608' opacity='.9'/%3E%3Cpath d='M92 32H64c-6 0-6 6-6 6v52s0-6 6-6h28z' fill='%23060608'/%3E%3C/svg%3E",
  ...
  // Wrench, puzzle, shield, etc.
  wrench: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%236366f1'/%3E%3Cpath d='M78 28a24 24 0 0 0-32 32L26 80l6 6 20-20a24 24 0 0 0 32-32z' fill='%23ffffff'/%3E%3C/svg%3E",
  ...
  clock: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%23f1f5f9'/%3E%3Ccircle cx='60' cy='60' r='32' stroke='%230f172a' stroke-width='6' fill='none'/%3E%3Cline x1='60' y1='60' x2='60' y2='38' stroke='%230f172a' stroke-width='6' stroke-linecap='round'/%3E%3Cline x1='60' y1='60' x2='76' y2='70' stroke='%230f172a' stroke-width='5' stroke-linecap='round'/%3E%3C/svg%3E",
  eye: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%23ec4899'/%3E%3Cpath d='M18 60s22-28 42-28 42 28 42 28-22 28-42 28-42-28-42-28z' stroke='%23ffffff' stroke-width='6' fill='none'/%3E%3Ccircle cx='60' cy='60' r='14' fill='%23ffffff'/%3E%3C/svg%3E",
  ...
  layers: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%236366f1'/%3E%3Cpath d='M60 28l32 18-32 18-32-18z' fill='%23ffffff' opacity='.4'/%3E%3Cpath d='M60 48l32 18-32 18-32-18z' fill='%23ffffff' opacity='.7'/%3E%3Cpath d='M60 68l32 18-32 18-32-18z' fill='%23ffffff'/%3E%3C/svg%3E",
  mail: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%23ea4335'/%3E%3Cpath d='M24 36h72v48H24z' fill='%23ffffff'/%3E%3Cpath d='M24 40l36 24 36-24' stroke='%23ea4335' stroke-width='6' fill='none' stroke-linecap='round' stroke-linejoin='round'/%3E%3C/svg%3E",
  notification: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%23eab308'/%3E%3Cpath d='M48 28c-14 0-22 10-22 24v20l-8 8v4h60v-4l-8-8V52c0-14-8-24-22-24z' fill='%23ffffff'/%3E%3C/svg%3E",
  grid: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%23000000'/%3E%3Crect x='26' y='26' width='28' height='28' rx='6' fill='%23ffffff'/%3E%3Crect x='66' y='26' width='28' height='28' rx='6' fill='%23ffffff' opacity='.6'/%3E%3Crect x='26' y='66' width='28' height='28' rx='6' fill='%23ffffff' opacity='.6'/%3E%3Crect x='66' y='66' width='28' height='28' rx='6' fill='%23ffffff' opacity='.3'/%3E%3C/svg%3E",
  ziklag: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Crect width='120' height='120' rx='28' fill='%231a1a2e'/%3E%3Crect x='28' y='32' width='64' height='56' rx='4' stroke='%2300ff88' stroke-width='3' fill='none'/%3E%3Cpath d='M48 50l8 8-8 8' stroke='%2300ff88' stroke-width='3' fill='none' stroke-linecap='round' stroke-linejoin='round'/%3E%3Cline x1='62' y1='66' x2='78' y2='66' stroke='%2300ff88' stroke-width='3' stroke-linecap='round'/%3E%3C/svg%3E",
  analytics: "data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 120 120'%3E%3Cdefs%3E%3ClinearGradient id='a' x1='0' y1='0' x2='1' y2='1'%3E%3Cstop offset='0%25' stop-color='%2322c55e'/%3E%3Cstop offset='100%25' stop-color='%2316a34a'/%3E%3C/linearGradient%3E%3C/defs%3E%3Crect width='120' height='120' rx='28' fill='url(%23a)'/%3E%3Cpath d='M28 80l20-20 16 10 28-34' stroke='%23fff' stroke-width='5' fill='none' stroke-linecap='round' stroke-linejoin='round'/%3E%3Ccircle cx='28' cy='80' r='4' fill='%23fff'/%3E%3Ccircle cx='48' cy='60' r='4' fill='%23fff'/%3E%3Ccircle cx='64' cy='70' r='4' fill='%23fff'/%3E%3Ccircle cx='92' cy='36' r='4' fill='%23fff'/%3E%3C/svg%3E",
};
